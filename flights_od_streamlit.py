...
with header_container:
	...
	st.subheader("We are analyzing US domestic flight data for January 2007")
...
with st.sidebar:
    selected=option_menu(menu_title='Contents', options=['EAD', 'O-D Analysis', 'Airports', 'Carrier'])
types={'Categorical':['Origin', 'Dest', 'UniqueCarrier', 'FlightNum'], 'Numerical':['ArrTime', 'CRSArrTime', 'DepDelay', 'ActualElapsedTime', 'CRSElapsedTime', 'AirTime', 'ArrDelay', 'DepDelay' ]}
...
if selected=='EAD':
 ...
 with EAD:
    ...
    v=radio
    box=st.selectbox('Select the variable to analyze', types[v])
